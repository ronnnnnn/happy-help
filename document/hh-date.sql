...
INSERT INTO `hh_resource` VALUES (1,'资源','menu','',0,'0/','',1,''),(40,'用户资源管理','menu','',1,'0/1/','',1,''),(41,'管理员管理','menu',' ',40,'0/1/40/','superuser:*',1,'/user/superuser/list'),(42,'管理员新增','button',' ',41,'0/1/40/41','superuser:create',1,' '),(43,'管理员修改','button',' ',41,'0/1/40/41','superuser:update',1,' '),(44,'管理员删除','button',' ',41,'0/1/40/41','superuser:delete',1,' '),(45,'管理员查看','button',' ',41,'0/1/40/41','superuser:view',1,' '),(50,'用户管理','menu','',40,'0/1/40','user:*',1,'/user/normaluser/list'),(51,'用户新增','button','',50,'0/1/40/50/','user:create',1,''),(52,'用户修改','button','',50,'0/1/40/50/','user:update',1,''),(53,'用户删除','button','',50,'0/1/40/50/','user:delete',1,''),(54,'用户查看','button','',50,'0/1/40/50/','user:view',1,''),(55,'资源管理','menu','',40,'0/1/40/','resource:*',1,'/resource'),(56,'资源新增','button','',55,'0/1/40/55/','resource:create',1,''),(57,'资源修改','button','',55,'0/1/40/55/','resource:update',1,''),(58,'资源删除','button','',55,'0/1/40/55/','resource:delete',1,''),(59,'资源查看','button','',55,'0/1/40/55/','resource:view',1,''),(60,'角色管理','menu','',40,'0/1/40/','role:*',1,'/role'),(61,'角色新增','button','',60,'0/1/40/60/','role:create',1,''),(62,'角色修改','button','',60,'0/1/40/60/','role:update',1,''),(63,'角色删除','button','',60,'0/1/40/60/','role:delete',1,''),(64,'角色查看','button','',60,'0/1/40/60/','role:view',1,'');
...
INSERT INTO `hh_role` VALUES (1,'admin','超级管理员','41,50,55,60',1),(2,'normal','普通用户','0',1);
...
-- Dump completed on 2016-10-19 19:16:54
